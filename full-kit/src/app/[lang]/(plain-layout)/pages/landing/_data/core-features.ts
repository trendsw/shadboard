...
export const coreFeaturesData: CoreFeatureType[] = [
  {
    title: "React 19",
    description:
      "Built using React 19 for enhanced performance, concurrency, and developer experience.",
    icon: SiReact,
  },
  {
    title: "Next.js 15",
    description:
      "Powered by Next.js 15, ensuring server-side rendering, SEO optimization, and app router support.",
    icon: SiNextdotjs,
  },
  {
    title: "Tailwind CSS 4",
    description:
      "Styled with Tailwind CSS 4, offering a utility-first approach for fast and responsive UI design.",
    icon: SiTailwindcss,
  },
  {
    title: "Radix UI",
