...
2. **npm** (Node Package Manager)  
   npm comes bundled with Node.js. You can check if npm is installed by running the following command:
...
After extracting the project and selecting your preferred version, install the required dependencies using npm:
