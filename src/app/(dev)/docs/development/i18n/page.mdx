...
## 5. Update the `getDictionary.ts` File

Modify the `src/lib/getDictionary.ts` file to include the necessary language dictionaries within the `dictionaries` object.
